import { memo, useRef, useEffect, useReducer, useCallback, useMemo, useState, useLayoutEffect } from 'react';
  ...
  if (!width || Number.isNaN(Number(width))) {
    return /* @__PURE__ */ jsx(
      ...
      __spreadProps(__spreadValues({}, rest), {
        ...
        rowSpan,
        colSpan,
        children: /* @__PURE__ */ jsx("span", { title, children })
      })
    );
  }
          ...
          Resizable,
          {
            ...
            handle: /* @__PURE__ */ jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsx("div", { className: "resizable-line" })
              }
            ),
            ...
            onResizeStop: onStop,
            children: /* @__PURE__ */ jsx("div", { style: { width: resizeWidth, height: "100%" } })
          }
        ),
        /* @__PURE__ */ jsx("div", __spreadProps(__spreadValues({}, rest), { className: `resizable-title ${isSimpleChildren() ? "ellipsis" : ""}`, children: /* @__PURE__ */ jsx("span", { title, children }) }))
      ]
    }
  );
};
var ResizableHeader_default = memo(ResizableHeader);
...
function useGetDataIndexColumns(columns) {
  const dataIndexColumns = useMemo(() => getColumns(columns), [columns]);
...
function useLocalColumns({
  ...
  const [localColumns, setLocalColumns] = useState(initLocalColumns);
  useEffect(() => {
...
function useAntdResizableHeader(props) {
  ...
  const widthCache = useRef(/* @__PURE__ */ new Map());
...
export { ResizableUniqIdPrefix, src_default as default, useAntdResizableHeader };
